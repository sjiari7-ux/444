...
const KINGDOMS = [
  { id:'europe',        name:'Kingdom of Europe',              emblem:'🏰', color:'#3a5a8f', description:'Castles, chivalry, and old-world craftsmanship unite the realms of Europe.' },
  ...
  { id:'arab_world',     name:'Sultanate of the Arab World',    emblem:'🕌', color:'#0f7a5c', description:'Desert traders and desert warriors, bound by honor and hospitality.' },
  { id:'africa',         name:'Kingdom of Africa',              emblem:'🦁', color:'#b56b06', description:'The cradle of civilization rises again under a united banner.' },
  ...
  { id:'south_america',  name:'Federation of South America',    emblem:'🐆', color:'#1f8a4c', description:'Rainforest warriors and carnival spirit fuel the Federation.' },
];
...
function renderAllianceOverview(){
  ...
  const rankCards = [
    ...
    { cls:'gold', icon:`<img class="ui-icon" src="${ICONS.trophy}" alt="🏆">`, label:'Total Contribution', value: fmtG(alliance.points||0) },
    { cls:'mint', icon:`<img class="ui-icon" src="${ICONS.group}" alt="👥">`, label:'Active Members', value: `${activeThisWeek}/${memberCount}` },
    { cls:'mint', icon:`<img class="ui-icon" src="${ICONS.castle}" alt="🏰">`, label:'Kingdom Level', value: alliance.level||1 },
    { cls:'mint', icon:`<img class="ui-icon" src="${ICONS.medal}" alt="🎖">`, label:'Roster', value: `${alliance.memberCount||memberCount}` },
  ];
  ...
  return `
    <div class="panel" style="margin-bottom:10px;">
      <div class="panel-header"><img class="ui-icon" src="${ICONS.upgrade_scroll}" alt="📈"> Rankings</div>
    ...
    <div class="panel" style="margin-bottom:10px;">
      <div class="panel-header"><img class="ui-icon" src="${ICONS.castle}" alt="🏰"> Government</div>
      ${govOrder.length ? `
        <div class="gov-row">
          ${govOrder.map(m => {

...
if (auth) {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (errorBox) {
      errorBox.textContent = `<img class="ui-icon" src="${ICONS.offline}" alt="🔌"> Could not reach Firebase. Arcadia MMO needs a live connection to play — check your internet connection or disable any ad blocker / privacy extension blocking Google/Firebase, then reload.`;

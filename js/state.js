...
const ZONES = [
    { id:'plains',   name:'Plains',   nameAr:'Plains',     icon:`<img class="ui-icon" src="${ICONS.park}" alt="🏞">`, levelMin:1,  levelMax:10, energyCost:10, color:'#3f6b52' },
    { id:'forest',   name:'Forest',   nameAr:'Forest',    icon:`<img class="ui-icon" src="${ICONS.tree}" alt="🌳">`, levelMin:10, levelMax:25, energyCost:12, color:'#2f6b40' },
    { id:'mountain', name:'Mountain', nameAr:'Mountain',     icon:`<img class="ui-icon" src="${ICONS.mountain}" alt="🏔">`, levelMin:25, levelMax:40, energyCost:14, color:'#52606f' },
    { id:'cave',     name:'Cave',     nameAr:'Cave',     icon:`<img class="ui-icon" src="${ICONS.candle}" alt="🕯">`, levelMin:40, levelMax:55, energyCost:16, color:'#5f4f96' },
    { id:'swamp',    name:'Swamp',    nameAr:'Swamp',  icon:`<img class="ui-icon" src="${ICONS.herb}" alt="🌿">`, levelMin:55, levelMax:70, energyCost:18, color:'#3d6b4a' },
    { id:'dark',     name:'Dark Zone',nameAr:'Dark Zone', icon:`<img class="ui-icon" src="${ICONS.dark_mode}" alt="🌑">`, levelMin:70, levelMax:999, energyCost:20, color:'#b23a3a' },
];

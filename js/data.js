...
const GEAR_TIERS = [
  ...
  { name:'Common',    color:'#78716c', symbol:'●',    power:1.00, minLevel:1,  maxUpgrade:0, numStats:1, sellMin:30,  sellMax:100,  statRange:[0.90,1.30] },
  { name:'Uncommon',  color:'#0d9488', symbol:'◆',    power:1.25, minLevel:10, maxUpgrade:1, numStats:2, sellMin:150, sellMax:400,  statRange:[0.90,1.40] },
  { name:'Rare',      color:'#0284c7', symbol:`<img class="ui-icon" src="${ICONS.star_filled}" alt="★">`,    power:1.50, minLevel:25, maxUpgrade:2, numStats:3, sellMin:500, sellMax:1500, statRange:[0.90,1.50] },
  { name:'Epic',      color:'#9333ea', symbol:`◆<img class="ui-icon" src="${ICONS.star_filled}" alt="★">`,   power:2.00, minLevel:40, maxUpgrade:3, numStats:4, sellMin:2000,sellMax:5000,  statRange:[1.00,1.60] },
  { name:'Legendary', color:'#d97706', symbol:`<img class="ui-icon" src="${ICONS.star_filled}" alt="★"><img class="ui-icon" src="${ICONS.star_filled}" alt="★"><img class="ui-icon" src="${ICONS.star_filled}" alt="★">`,  power:3.00, minLevel:55, maxUpgrade:5, numStats:5, sellMin:8000,sellMax:20000, statRange:[1.00,1.80] },
...
const CLASS_DATA = {
  warrior: {
    name: 'Warrior', nameAr: 'Warrior', icon: `<img class="ui-icon" src="${ICONS.damage_ui}" alt="⚔">`, color: '#dc2626',
  ...
  archer: {
    name: 'Archer', nameAr: 'Archer', icon: `<img class="ui-icon" src="${ICONS.bow}" alt="🏹">`, color: '#0d9488',
  ...
  mage: {
    name: 'Mage', nameAr: 'Mage', icon: `<img class="ui-icon" src="${ICONS.mana}" alt="🔮">`, color: '#9333ea',
  ...
  support: {
    name: 'Support', nameAr: 'Support', icon: `<img class="ui-icon" src="${ICONS.heal}" alt="💚">`, color: '#16a34a',
  ...
  merchant: {
    name: 'Merchant', nameAr: 'Merchant', icon: `<img class="ui-icon" src="${ICONS.business}" alt="💰">`, color: '#b45309',

...
const GEAR_TIERS = [
  ...
  { name:'Rare',      color:'#7ec8dc', symbol:`<img class="ui-icon" src="${ICONS.star_filled}" alt="★">`,    power:1.50, minLevel:25, maxUpgrade:2, numStats:3, sellMin:500, sellMax:1500 },
  { name:'Epic',      color:'#a679c9', symbol:`◆<img class="ui-icon" src="${ICONS.star_filled}" alt="★">`,   power:2.00, minLevel:40, maxUpgrade:3, numStats:4, sellMin:2000,sellMax:5000 },
  { name:'Legendary', color:'#f0b860', symbol:`<img class="ui-icon" src="${ICONS.star_filled}" alt="★"><img class="ui-icon" src="${ICONS.star_filled}" alt="★"><img class="ui-icon" src="${ICONS.star_filled}" alt="★">`,  power:3.00, minLevel:55, maxUpgrade:5, numStats:5, sellMin:8000,sellMax:20000},
  { name:'Mythic',    color:'#c73f38', symbol:`<img class="ui-icon" src="${ICONS.star_small}" alt="✦">`,    power:4.00, minLevel:70, maxUpgrade:7, numStats:6, sellMin:25000,sellMax:50000},
];

const GEAR_SLOTS = {
  weapon:    { name:'Weapon',    icon:`<img class="ui-icon" src="${ICONS.damage_ui}" alt="⚔">` },
  armor:     { name:'Armor',     icon:`<img class="ui-icon" src="${ICONS.defense_ui}" alt="🛡">` },
  helmet:    { name:'Helmet',    icon:`<img class="ui-icon" src="${ICONS.helmet_cross}" alt="⛑">` },
  boots:     { name:'Boots',     icon:`<img class="ui-icon" src="${ICONS.boots}" alt="👢">` },
  accessory: { name:'Accessory', icon:`<img class="ui-icon" src="${ICONS.ring}" alt="💍">` },
  gloves:    { name:'Gloves',    icon:`<img class="ui-icon" src="${ICONS.gloves}" alt="🧤">` },
};

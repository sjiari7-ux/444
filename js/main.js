...
function renderBottomNav(){
  ...
  const tabs = [
    {id:'production',icon:`<img class="nav-icon-img" src="${ICONS.nav_production}" alt="Craft">`,label:'Craft'},
    {id:'market',icon:`<img class="nav-icon-img" src="${ICONS.nav_market}" alt="Market">`,label:'Market'},
    {id:'zones',icon:`<img class="nav-icon-img" src="${ICONS.nav_zones}" alt="Zones">`,label:'Zones'},
    {id:'gear',icon:`<img class="nav-icon-img" src="${ICONS.nav_gear}" alt="Gear">`,label:'Gear'},
    {id:'companies',icon:'🏭',label:'Biz'},
    {id:'alliance',icon:`<img class="nav-icon-img" src="${ICONS.nav_alliance}" alt="Alliance">`,label:'Alliance'},
    {id:'settings',icon:`<img class="nav-icon-img" src="${ICONS.nav_settings}" alt="Settings">`,label:'More'},
  ];
